...
def query():
    ...
    for row in cur:
        ...
        mfstruct[current_group]['1_count_quant'] = 0
        mfstruct[current_group]['1_max_quant'] = float('-inf')
        mfstruct[current_group]['2_count_quant'] = 0
    ...
    try:
        for groupingattributekey in list(mfstruct):
            if not (mfstruct[groupingattributekey]['1_count_quant'] > mfstruct[groupingattributekey]['2_count_quant'] ):
    ...
    for groupingattributekey, aggrfuncmap in mfstruct.items():
        ...
        row['2_count_quant'] = aggrfuncmap['2_count_quant']
